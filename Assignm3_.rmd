...
- CAR [-3;0] on a 4-day-window level turned out to be more representative, thus the following regression refers to CAR4d. 
- The sectors that were most represented in the dataset are show in the figure (No. of companies within the respective sector). 
- Plotting the regression of CAR4d and UE highlighting the different sectors and quarters show a diverse picture which could explain the variation in CAR and UE.
