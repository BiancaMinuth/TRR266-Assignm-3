...
library(stargazer)
library(kableExtra)
load("C:/Dokumente/1 PhD Programm/Courses/External/HU/Assignment 3/TRR266-Assignm-1_test4/output/results.rda")
...
df_ind <- df[df$hsiccd %in% c("6798", "7370", "2834",  "4911", "3674", "7372", "1311"),]   
...
- The data shows statistically significant result on a 10 % level for CAR4d ~ UE.
...
```{r CAR4d_quarter}
fig_5  <- plot(df$quarter, df$CAR3d)
...
- ERCs were shown to be an increasing function of the extent an earnings announcement results in a revision in expected earnings (sign: 10% level).
- The variations be explained by the differences between the sectors and quarters (see Figure IV).
